...
parser.add_argument('--train_img_dir', type=str, default='./img_align_celeba/train')
parser.add_argument('--train_attr_path', type=str, default='./img_align_celeba/train/list_attr_celeba_train.txt')
parser.add_argument('--test_img_dir', type=str, default='./img_align_celeba/test')
parser.add_argument('--test_attr_path', type=str, default='./img_align_celeba/test/list_attr_celeba_test.txt')
